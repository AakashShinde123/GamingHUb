...
This report was automatically generated by the PlayHub Management System.
    `;
    ...
    a.href = url;
    a.download = `playhub-report-${new Date().toISOString().split('T')[0]}.txt`;
...
${new Date(Date.now() - 172800000).toLocaleDateString()},13800,20,80%
    ...
    const a = document.createElement('a');
    a.href = url;
    a.download = `playhub-data-${new Date().toISOString().split('T')[0]}.csv`;
    document.body.appendChild(a);
    a.click();
    document.body.removeChild(a);
    URL.revokeObjectURL(url);
            ...
            <Card className="border-l-4 border-gaming-green">
              ...
              <CardContent className="space-y-4">
                ...
                <div className="p-4 bg-gaming-purple/10 rounded-lg">
                  <h4 className="font-medium text-gaming-purple mb-2">PlayHub Info</h4>
